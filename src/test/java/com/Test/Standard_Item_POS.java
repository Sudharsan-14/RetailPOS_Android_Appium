...
public class Standard_Item_POS {
	...
	ExtentTest test = rep.startTest("Standard Item POS Issue");
...
//	@Test(priority = 2)
//	public void Amount_Should_Be_Changed_When_Delete_Ordered_Item() throws Throwable {
//		lp = new Login_Page(driver, test);
...
//	}
	...
	@Test(priority = 3)
	public void Closed_Check_Missing() throws Throwable {
		lp = new Login_Page(driver, test);
		cm = new Common_xpath(driver, test);
		psp = new Pin_Screen_Page(driver, test);
		rop = new RetailPOS_Order_Page(driver, test);
		...
		sip.Verify_The_Closed_Check(Check_NO);
		rop.Log_Off_to_Pinscreen();
	}
